...
class C01 extends \EndoGuard\\Assets\Rule {
    ...
    protected function prepareParams(array $params): array {
        $params['eip_has_specific_country'] = in_array(\EndoGuard\\Utils\Constants::get()->COUNTRY_CODE_NIGERIA, $params['eip_country_id']);
