...
class C09 extends \EndoGuard\\Assets\Rule {
    ...
    protected function prepareParams(array $params): array {
        $params['eip_has_specific_country'] = in_array(\EndoGuard\\Utils\Constants::get()->COUNTRY_CODE_PHILIPPINES, $params['eip_country_id']);
