...
class C06 extends \EndoGuard\\Assets\Rule {
    ...
    protected function prepareParams(array $params): array {
        $params['eip_has_specific_country'] = in_array(\EndoGuard\\Utils\Constants::get()->COUNTRY_CODE_INDONESIA, $params['eip_country_id']);
